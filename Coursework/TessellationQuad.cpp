...
TessellationQuad::TessellationQuad(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int lresolution)
{
...
void TessellationQuad::sendData(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
